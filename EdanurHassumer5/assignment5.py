...
on=0
a=0.2
position= Vec3d(0.2, 0.2, 0.2, 1.0)
direction=Vec3d(a, a, -1.0, 0.0)
# Shapes
number=0 
num=1
...
#parser=ParserObj("cornell.obj")
objelist=parser.parseMulti()
print("For zoom in enter --->  r")
print("For zoom out enter --->  q")
print("For stopping the ligth enter --->  a")   
...
def InitGL(Width, Height):				# We call this right after our OpenGL window is created.
    ...
    gluPerspective(85.0, float(Width)/float(Height), 0.1, 100.0)
...
def DrawGLScene():
    ...
    global cube,number, sphere, camera,num,objelist,spot,position,direction,a,control
    ...
    spot.drawMove(position,direction,a)
   
    spot.draw()
  
 
    glTranslatef(0.0, -25.0, -65.0)
    for i in objelist:
        i.drawTri()
...
def keyPressed(*args):
    theta=0
    global number, camera,obje,parser,num, firstvertices, firstquads,position,on
...
def main():
	...
	window = glutCreateWindow("CENG487 Assignment5 -Edanur Hassumer")
