...
class Cube(_Shape):
	def __init__(self, name, xSize, ySize, zSize, xDiv, yDiv, zDiv):
		...
		vertices.append( Point3f(-xSize / 2.0, ySize / 2.0, -zSize / 2.0) )
		vertices.append( Point3f(xSize / 2.0, ySize / 2.0, -zSize / 2.0) )"""
		vertices.append( Point3f(xSize-2 , ySize-2 , zSize ) )
		vertices.append( Point3f(xSize , ySize-2 , zSize ) )
		vertices.append( Point3f(xSize-2 , ySize , zSize ) )
		vertices.append( Point3f(xSize , ySize , zSize ) )
		vertices.append( Point3f(xSize-2 , ySize -2, zSize-2) )
		vertices.append( Point3f(xSize , ySize-2 , zSize-2 ) )
		vertices.append( Point3f(xSize-2 , ySize , zSize-2 ) )
		vertices.append( Point3f(xSize , ySize , zSize-2 ) )
